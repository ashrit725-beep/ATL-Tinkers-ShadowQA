...
4. PLAN the smallest logical change that makes the user's intent succeed by fixing the root cause. Do not add defensive guards that merely hide the symptom when a real contract mismatch exists. Do not refactor, rename, reformat or touch unrelated code. Preserve the file's style.
